          ...
          child: PageView(
            ...
            children: [
              buildPage(
                ...
                urlImage: 'assets/apta.jpg',
                title: 'Una aplicación móvil de videojuegos',
                subtitle: 'Aplicación apto para toda la familia.'
              ),
              buildPage(
                color: Color.fromARGB(255, 142, 255, 97),
                urlImage: 'assets/fav.jpg',
                title: 'Elección de tu videojuego favorito',
                subtitle: 'Aplicación móvil para poder comprar o guardar en el carrito de compras'
              ),
              buildPage(
                color: Color.fromARGB(255, 70, 255, 63),
                urlImage: 'assets/lap1.jpg',
                title: 'Podrás buscar tu videojuego favorito :D',
